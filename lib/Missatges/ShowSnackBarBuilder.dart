...
class FrmSnackBarBuilder extends StatelessWidget {
  const FrmSnackBarBuilder({super.key});
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(textFieldValue == null || textFieldValue.isEmpty ? "No s'ha introduït res." : textFieldValue), // Mostra el text introduït o un missatge si està buit.
